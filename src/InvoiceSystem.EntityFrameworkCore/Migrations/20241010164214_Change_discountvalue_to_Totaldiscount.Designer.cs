...
namespace InvoiceSystem.Migrations
{
    ...
    [Migration("20241010164214_Change_discountvalue_to_Totaldiscount")]
    partial class Change_discountvalue_to_Totaldiscount
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("InvoiceSystem.Invoices.Invoice", b =>
                {
                    b.Property<Guid>("Id")
            ...
            modelBuilder.Entity("InvoiceSystem.Invoices.InvoiceItems", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("InvoiceSystem.Invoices.InvoiceItems", b =>
                {
                    b.HasOne("InvoiceSystem.Invoices.Invoice", "Invoice")
                        .WithMany("InvoiceItems")
                        .HasForeignKey("InvoiceId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("InvoiceSystem.Products.Product", null)
                        .WithOne("InvoiceItem")
                        .HasForeignKey("InvoiceSystem.Invoices.InvoiceItems", "ProductId")
